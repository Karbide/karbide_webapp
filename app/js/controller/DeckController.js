bController.controller('DeckController', ['$scope', 'CommonService', '$timeout', '$rootScope',
    function ($scope, CommonService, $timeout, $rootScope) {
        ...
        self.getAllDecks = function () {
            ...
            if (self.alldecks_url != null) {
                CommonService.getResponse(self.replacePlaceHolder(self.alldecks_url, "STATUS", $scope.getDeckStatus()) + $scope.deckPageNo).then(function (data) {
